...
public partial class QuasarDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdEmployeeRole).HasName("PRIMARY");

            entity.ToTable("EMPLOYEE_ROLES");

            entity.HasIndex(e => new { e.IdStaff, e.IdRolStaff }, "uq_employee_role").IsUnique();

            entity.Property(e => e.IdEmployeeRole).HasColumnName("id_employee_role");
            entity.Property(e => e.Active)
                .HasDefaultValueSql("'1'")
                .HasColumnName("active");
            ...
            entity.HasOne(d => d.IdStaffNavigation).WithMany(p => p.EmployeeRoles)
                .HasForeignKey(d => d.IdStaff)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("EMPLOYEE_ROLES_ibfk_1");

            entity.HasOne(d => d.IdRolStaffNavigation).WithMany(p => p.EmployeeRoles)
        ...
        {
            entity.HasKey(e => e.IdRolePermission).HasName("PRIMARY");

            entity.ToTable("ROLE_PERMISSIONS");

            entity.HasIndex(e => new { e.IdRolStaff, e.IdPermission }, "uq_role_permission").IsUnique();
            ...
            entity.HasOne(d => d.IdRolStaffNavigation).WithMany(p => p.RolePermissions)
                .HasForeignKey(d => d.IdRolStaff)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.IdSaleDetail).HasName("PRIMARY");

            entity.ToTable("SALE_DETAILS");

            entity.HasIndex(e => e.IdVenta, "id_venta");
            entity.HasIndex(e => e.IdEventoAsiento, "id_evento_asiento");
            entity.HasIndex(e => new { e.IdVenta, e.IdEventoAsiento }, "uq_sale_detail").IsUnique();
            ...
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.SaleDetails)
                .HasForeignKey(d => d.IdVenta)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("SALE_DETAILS_ibfk_1");

            entity.HasOne(d => d.IdEventoAsientoNavigation).WithMany()
                .HasForeignKey(d => d.IdEventoAsiento)
                .OnDelete(DeleteBehavior.ClientSetNull)
